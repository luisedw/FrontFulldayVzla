...
import { GestionarDestinosComponent } from './components/GestionarDestinosTuristicos/gestionar-destinos.component';
...
// 1. Ruta principal (Home)
  ...
  { path: 'admin/destinos', component: GestionarDestinosComponent },
